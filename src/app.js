 ...
 */
 ...
 import * as THREE from 'three';
    ...
    '<p class="lead" style="text-shadow: 2px 2px 4px black;">Use your keyboard arrows to move your penguin in a way that avoids the obstacles given. You can avoid obstacles by moving right, left, or jumping over it. Ice patches -increases speed. 3 lives. If you collide with rocks, logs, and trees cause you to lose a life. Collide with seals - die. Increases score- eat fish. Eat a squid - gain a boost- allows you to collide with rocks, logs, and trees without losing any lives, but seals will still kill you.</p>' +
